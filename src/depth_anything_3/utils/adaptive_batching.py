...
MODEL_MEMORY_PROFILES: dict[str, ModelMemoryProfile] = {
    ...
    "da3nested-giant-large-1.1": ModelMemoryProfile(
        base_memory_mb=6000,
        per_image_mb_at_504=1500,
        activation_scale=1.8,
    ),
...
class AdaptiveBatchSizeCalculator:
    ...
    def compute_optimal_batch_size(
        ...
        usable_mb = (
            available_mb * self.config.target_memory_utilization
        ) - reserved_memory_mb
    ...
    def update_from_profiling(
        self, batch_size: int, memory_used_mb: float, process_res: int
    ) -> None:
        ...
        memory_at_504 = (
            memory_per_image / resolution_scale / self.profile.activation_scale
        )
...
def estimate_max_batch_size(
    ...
    return calculator.compute_optimal_batch_size(
        num_images=1000, process_res=process_res
    )
