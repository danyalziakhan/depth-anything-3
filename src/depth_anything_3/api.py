...
class DepthAnything3(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.device.type in ("cuda", "mps"):
            ...
            decoding_info = (
                "NVJPEG support enabled"
                if self.device.type == "cuda"
                else "TorchVision decoding"
            )
    ...
    def forward(
        ...
        with torch.no_grad():
            ...
            if image.device.type == "mps":
                ...
                with torch.autocast(
                    device_type=image.device.type, dtype=autocast_dtype
                ):
                    return self.model(
                        image,
                        extrinsics,
    ...
    def inference(
        ...
        Args:
            ...
            infer_gs: Enable the 3D Gaussian branch (needed for `gs_ply` exports)
            ...
            export_format: Export format (mini_npz, npz, glb, ply, gs)
    ...
    def _preprocess_inputs(
        ...
        perform_norm = True
        if self.device.type in ("cuda", "mps") and not isinstance(
            self.input_processor, GPUInputProcessor
        ):
            perform_norm = False
    ...
    def _prepare_model_inputs(
        ...
        ex_t = (
            ...
            and extrinsics.device.type == "cpu"
        ...
        in_t = (
            ...
            and device.type == "cuda"
            and intrinsics.device.type == "cpu"
